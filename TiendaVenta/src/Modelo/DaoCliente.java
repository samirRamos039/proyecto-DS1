...
public class DaoCliente {
    ...
    public int actualizar(String id, String nombre, String apellido, String direccion, String telefono, String correo, String razonSocial){
        String SQL = "UPDATE public.cliente SET nombres='"+ nombre +"' ,apellido='"+ apellido +"' ,direccion='"+ direccion +"' ,telefono='"
                                                        + telefono +"' ,correo='"+ correo +"' ,razonsocial='"+ razonSocial +"'  WHERE id='"+ id +"'";
